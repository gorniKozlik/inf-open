...
void solve() {
    ...
    while (can < n) {
        ...
        tree.upd(seg1.first, 3 * n + 1, -1);
        tree.upd(seg1.second + 1, 3 * n + 1, 1);
        tree.upd(seg2.first, 3 * n + 1, -1);
        tree.upd(seg2.second + 1, 3 * n + 1, 1);

        pair<int, int> ns1 = {seg1.first, seg2.first};
        pair<int, int> ns2 = {seg1.second, seg2.second};

        tree.upd(ns1.first, 3 * n + 1, 1);
        tree.upd(ns1.second + 1, 3 * n + 1, -1);
        tree.upd(ns2.first, 3 * n + 1, 1);
        tree.upd(ns2.second + 1, 3 * n + 1, -1);
