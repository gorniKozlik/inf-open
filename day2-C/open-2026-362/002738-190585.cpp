...
void solve() {
    ...
    if (n > 3000) {
        best_covered_1.resize(min(sz(best_covered_1), 900));
        best_covered_2.resize(min(sz(best_covered_2), 900));
        best_covered_3.resize(min(sz(best_covered_3), 900));
        best_covered_4.resize(min(sz(best_covered_4), 900));
    } else {
