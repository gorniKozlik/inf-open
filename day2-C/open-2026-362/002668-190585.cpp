...
void solve() {
    ...
    if (n > 3000) {
        best_covered_1.resize(min(sz(best_covered_1), 300));
        best_covered_2.resize(min(sz(best_covered_2), 300));
        best_covered_3.resize(min(sz(best_covered_3), 300));
        best_covered_4.resize(min(sz(best_covered_4), 300));
    } else {
